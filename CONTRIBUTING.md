...
- Search [existing issues](https://github.com/ywatanabe1989/scitex-path/issues)
  before opening a new one.
- Include a minimal reproducible example when reporting bugs.
- Specify your Python version, OS, and `scitex-path` version.

## Development Setup

```bash
git clone git@github.com:ywatanabe1989/scitex-path.git
cd scitex-path
pip install -e ".[dev]"
```
