...
def test_get_spath_default():
    ...
    with patch("scitex_path._get_spath.split") as mock_split:
        with patch("inspect.stack") as mock_stack:
            ...
            with patch("scitex_path._get_spath.__file__", "/test/path/module.py"):
                result = get_spath()
    ...
    with patch("scitex_path._get_spath.split") as mock_split:
        with patch("inspect.stack") as mock_stack:
            with patch("os.makedirs") as mock_makedirs:
                ...
                with patch("scitex_path._get_spath.__file__", "/test/module.py"):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch("scitex_path._get_spath.split") as mock_split:
            with patch("inspect.stack") as mock_stack:
                ...
                with patch("scitex_path._get_spath.__file__", test_file):
    ...
    with patch("scitex_path._get_spath.split") as mock_split:
        with patch("inspect.stack") as mock_stack:
            with patch.dict(os.environ, {"USER": "testuser"}):
                ...
                with patch(
                    "scitex_path._get_spath.__file__", "/path/to/ipython/module.py"
                ):
                    result = get_spath()
