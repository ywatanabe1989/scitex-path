...
class TestFindDir:
    ...
    def test_find_dir_calls_find_with_correct_params(self):
        ...
        with patch(
            "scitex_path._find._find", return_value=["/path/to/dir"]
        ) as mock_find:
    ...
    def test_find_dir_with_pattern(self):
        ...
        with patch("scitex_path._find._find", return_value=expected_dirs):
            result = find_dir("/root", "test_*")
...
class TestFindFile:
    ...
    def test_find_file_calls_find_with_correct_params(self):
        ...
        with patch(
            "scitex_path._find._find", return_value=["/path/to/file.txt"]
        ) as mock_find:
    ...
    def test_find_file_with_pattern(self):
        ...
        with patch("scitex_path._find._find", return_value=expected_files):
            result = find_file("/root", "*.txt")
