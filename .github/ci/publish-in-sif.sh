...
# (project=scitex-path, owner=ywatanabe1989, repo=scitex-path,
...
TMPDIR="/tmp/publish-scitex_path-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-path dist/* uploaded to PyPI via manual OIDC trusted publishing"
